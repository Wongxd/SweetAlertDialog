Base on [pedant/sweet-alert-dialog](https://github.com/pedant/sweet-alert-dialog)

Suit for Android Stuido V3.3.1 or higher.


## 安装
使用SweetAlertDialog最简单的办法就是像下面这样添加项目依赖。

[![](https://jitpack.io/v/Wongxd/SweetAlertDialog.svg)](https://jitpack.io/#Wongxd/SweetAlertDialog)
...
**Gradle**
    ...
    dependencies {
        implementation 'com.github.Wongxd:SweetAlertDialog:x.y.z'
    }
