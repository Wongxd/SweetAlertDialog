package io.wongxd.SweetAlertDialog;
...
public class ProgressHelper {
    ...
    public ProgressHelper(Context ctx) {
        mToSpin = true;
        mSpinSpeed = 0.75f;
        mBarWidth = ctx.getResources().getDimensionPixelSize(R.dimen.sweet_alert_common_circle_width) + 1;
        mBarColor = ctx.getResources().getColor(R.color.sweet_alert_success_stroke_color);
        mRimWidth = 0;
        mRimColor = 0x00000000;
        mIsInstantProgress = false;
        mProgressVal = -1;
        mCircleRadius = ctx.getResources().getDimensionPixelOffset(R.dimen.sweet_alert_progress_circle_radius);
    }
